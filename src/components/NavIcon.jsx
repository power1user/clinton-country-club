...
export default function NavIcon({ id, active }) {
  // Inactive icon stroke used to be #446854 — barely legible against
  // the #152E24 nav bar (~2:1 contrast). Bumped to the app's bright
  // sage so unselected tabs are clearly readable without competing
  // with the active brass tint.
  const clr = active ? G.brass : '#A8D8B8';
  const icons = {
